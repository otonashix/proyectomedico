     ...
     <div class="image">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link active" style="background-color:#ac7110;" onclick="cargar_contenido('contenido_principal','recepcionista/vista_recepcionista_listar.php')" >
        ...
        <div class="col-md-12">
            ...
            <div class="cardusuarioprincipal">
              ...
              <div class="card-body">
                ...
                <!--Texto Bienvenida-->
                <p style="font-size:18px; text-align: justify; margin-left: 25px;margin-right: 25px;">Estamos encantados de tenerte aquí como parte de este proceso. Como recepcionista, desempeñas un papel fundamental en la primera impresión que nuestros deportistas tienen de nuestra entidad. Tu amabilidad, 
                profesionalismo y eficiencia contribuyen significativamente a crear una experiencia positiva para todos los que nos visitan.
                Este sistema te proporcionará las herramientas necesarias para realizar tus tareas de manera efectiva y eficiente. 
                <br><br>Siempre estamos aquí para brindarte apoyo y orientación en caso de que lo necesites.<br><br>
