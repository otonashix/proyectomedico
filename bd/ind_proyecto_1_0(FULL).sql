...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2024 a las 19:00:50
...
CREATE  PROCEDURE `SP_REGISTRAR_USUARIO` (IN `CC` INT(10), IN `ROL` INT(1), IN `NOMBRE` VARCHAR(40), IN `CONTRA` VARCHAR(65))   BEGIN 
DECLARE  CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM usuario WHERE usuario.Usr_Id = CC);
IF @CANTIDAD=0 THEN
	INSERT INTO usuario(Usr_Id,Rol_Id,Usr_Nombre,Usr_Pswd,Est_Id) VALUES (CC,ROL,BINARY NOMBRE,CONTRA,1);
	SELECT 1;
ELSE
	SELECT 2;
END IF;
...
INSERT INTO `usuario` (`Usr_Id`, `Rol_Id`, `Usr_Nombre`, `Usr_Pswd`, `Est_Id`) VALUES
(1110, 2, 'Medico Prueba', '$2y$10$M4TXwzBm2p34p/95YTf7zuK0u1cNqtH2jJijQKg.jnaiYgLL5DsrK', 1),
(2220, 3, 'Recepcionista Prueba', '$2y$10$ajszNvX9Hx5yBxZPlhL2QerdsdpdfKqUdRt6ElH3IIHF.HieSlNcu', 2),
(1095832411, 1, 'Albert David Sanchez', '$2y$10$medVF4JNBTqG81rFu7aWi.C9AqrO9SpSKFxboosjqYDG5GEcondm.', 1),
(1110577198, 1, 'Juan Sebastian Tobar', '$2y$12$Qa7Q8b9ub1LDcziw4fjbVOx2.hiR0bKLJBqId4CQRK0nKOHHzVvyC', 1);
