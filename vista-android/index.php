     ...
     <div class="image">
        ...
        <div class="info"> 
         ...
         <div class="col-md-3 col-sm-4" style="color:#c2c7d0;"><i class="fa fa-user-gear"></i> <span>Administrador</span></div>
          <div class="col-md-3 col-sm-4" ><a href="../controlador/usuario/controlador_cerrar_sesion_android.php" class="d-block"><i class="fa fa-right-from-bracket"></i><span>Salir</span></a></div>
        </div>
      </div>
